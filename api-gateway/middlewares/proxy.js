...
module.exports = (app) => {
  ...
  app.use(
    ...
    (req, res, next) => {
      ...
      console.log("Method:", req.method); // Log method (GET, POST, etc.)
      console.log("URL:", req.originalUrl); // Log the full URL
      console.log("Headers:", req.headers); // Log request headers
      console.log("Body:", req.body); // Log the body (useful for POST/PUT)
      next();
    },
